...
const FAQPage = () => {
  ...
  const answerFontSize = !mobile ? '20px' : '16px'
    ...
    return (
        ...
        <Typography  sx={{fontFamily: 'Manrope', fontSize: answerFontSize}}>A: We recommend reading about travel in South Africa before you plan your trip. Here are a few good blogs about <a href="https://www.africaendeavours.com/destinations/south-africa/getting-there-getting-around" target="_blank" style={{'color': 'black', textDecoration: 'underline'}}>how to get to South Africa</a>, <a href="https://www.kiwi.com/stories/a-travel-guide-to-south-africa/" target="_blank" style={{'color': 'black', textDecoration: 'underline'}}>
          what to do when you’re in South Africa</a>, and <a href="https://www.nomadicmatt.com/travel-blogs/how-to-stay-safe-in-south-africa/" target="_blank" style={{'color': 'black', textDecoration: 'underline'}}>
            tips to stay safe</a> while visiting. </Typography>
